...
From today onward, I will solve **one Data Structures and Algorithms (DSA) problem every day** and document the progress in this repository.
...
|-----|---------|-------|--------|
| Day 1 | 121. Best Time to Buy and Sell Stock | Array | 🟩 |
